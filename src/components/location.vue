<template>
  <div class="bg-white">
    <div class="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
         <h2 class="text-3xl font-bold text-gray-900">Our Active Location</h2>
...
const products = [
  ...
  {
    id: 1,
    name: 'GreenBay Pluit , Jakarta Utara',
    href: '#',
